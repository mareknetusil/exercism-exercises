...
TEST_CASE("testing for eggs allergy -> not allergic to anything",
...
TEST_CASE("testing for strawberries allergy -> allergic to everything",
          "[74afaae2-13b6-43a2-837a-286cd42e7d7e]") {
    REQUIRE(true ==
            allergies::allergy_test(255).is_allergic_to("strawberries"));
}

TEST_CASE("testing for tomatoes allergy -> not allergic to anything",
          "[c49a91ef-6252-415e-907e-a9d26ef61723]") {
    REQUIRE(false == allergies::allergy_test(0).is_allergic_to("tomatoes"));
}

TEST_CASE("testing for tomatoes allergy -> allergic only to tomatoes",
...
TEST_CASE("list when: -> just peanuts",
...
TEST_CASE("list when: -> just strawberries",
...
TEST_CASE("list when: -> eggs and peanuts",
...
TEST_CASE("list when: -> more than eggs but not peanuts",
...
TEST_CASE("list when: -> lots of stuff",
          "[4b68f470-067c-44e4-889f-c9fe28917d2f]") {
    std::unordered_set<std::string> expected = {"strawberries", "tomatoes",
                                                "chocolate", "pollen", "cats"};
    REQUIRE(expected == allergies::allergy_test(248).get_allergies());
}

TEST_CASE("list when: -> everything",
...
TEST_CASE("list when: -> no allergen score parts",
...
TEST_CASE("list when: -> no allergen score parts without highest valid score",
