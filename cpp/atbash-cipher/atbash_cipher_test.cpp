...
TEST_CASE("encode_OMG") { REQUIRE("lnt" == atbash_cipher::encode("OMG")); }

TEST_CASE("encode_spaces") { REQUIRE("lnt" == atbash_cipher::encode("O M G")); }
