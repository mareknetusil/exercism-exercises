...
TEST_CASE("garden with single student",
          "[1fc316ed-17ab-4fba-88ef-3ae78296b692]") {
    std::array<kindergarten_garden::Plants, 4> expected{
        kindergarten_garden::Plants::radishes,
        kindergarten_garden::Plants::clover, kindergarten_garden::Plants::grass,
        kindergarten_garden::Plants::grass};
    REQUIRE(kindergarten_garden::plants("RC\nGG", "Alice") == expected);
}

TEST_CASE("different garden with single student",
...
TEST_CASE("garden with two students",
...
TEST_CASE("third student's garden", "[57712331-4896-4364-89f8-576421d69c44]") {
    std::array<kindergarten_garden::Plants, 4> expected{
        kindergarten_garden::Plants::grass, kindergarten_garden::Plants::grass,
        kindergarten_garden::Plants::grass, kindergarten_garden::Plants::grass};
    REQUIRE(kindergarten_garden::plants("VVCCGG\nVVCCGG", "Charlie") ==
            expected);
}

TEST_CASE("for Alice, first student's garden",
    ...
    std::array<kindergarten_garden::Plants, 4> expected{
        ...
        kindergarten_garden::Plants::violets,
        kindergarten_garden::Plants::radishes};
    REQUIRE(kindergarten_garden::plants(
                "VRCGVVRVCGGCCGVRGCVCGCGV\nVRCCCGCRRGVCGCRVVCVGCGCV",
                "Alice") == expected);
}

TEST_CASE("for Bob, second student's garden",
...
TEST_CASE("for Fred", "[a7e80c90-b140-4ea1-aee3-f4625365c9a4]") {
    std::array<kindergarten_garden::Plants, 4> expected{
        kindergarten_garden::Plants::grass, kindergarten_garden::Plants::clover,
        kindergarten_garden::Plants::violets,
        kindergarten_garden::Plants::clover};
    REQUIRE(kindergarten_garden::plants(
...
TEST_CASE("for Kincaid, second to last student's garden",
...
TEST_CASE("for Larry, last student's garden",
