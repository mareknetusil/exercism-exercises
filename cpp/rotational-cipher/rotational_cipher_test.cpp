...
TEST_CASE("rotate a by 0, same output as input",
...
TEST_CASE("rotate a by 26, same output as input",
...
TEST_CASE("rotate n by 13 with wrap around alphabet",
...
TEST_CASE("rotate numbers", "[ef32601d-e9ef-4b29-b2b5-8971392282e6]") {
    REQUIRE(rotational_cipher::rotate("Testing 1 2 3 testing", 4) ==
            "Xiwxmrk 1 2 3 xiwxmrk");
}

TEST_CASE("rotate punctuation", "[32dd74f6-db2b-41a6-b02c-82eb4f93e549]") {
    REQUIRE(rotational_cipher::rotate("Let's eat, Grandma!", 21) ==
            "Gzo'n zvo, Bmviyhv!");
}
